...
<template>
  <div class="mb-4">
    <h2 class="h6 mb-2">{{ t('feed_group_bigint') }}</h2>
    ...
    <table class="table table-sm align-middle" style="max-width: 60rem">
      ...
      <tbody>
        <tr v-for="row in store.rows.bigint" :key="row.column">
          <td>
          ...
          <td><input type="number" v-model="row.default" class="form-control form-control-sm" /></td>
